...
## 输出格式（严格遵守剧本中"输出规范"章节！）
回复必须包含三层：叙事 → 数值变化 → 4个选项。
- 叙事：综艺真人秀风格，200-400字，关键剧情500-800字
- 数值：每个变化独立【】包裹，如 【凝聚力+3】【秦悦 好感+5】
- 选项：恰好4个，格式"1. 选项文本"，放在回复最末尾，后面不加任何文字
示例：
（叙述内容）
【秦悦 好感+5】【团队凝聚力+3】【身心状态-2】
1. 和秦悦继续聊
2. 去集市逛逛
3. 回民宿休息
4. 找陈宇轩练歌`
